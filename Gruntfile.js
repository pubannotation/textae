module.exports = function(grunt) {
  grunt.initConfig({
    concat: {
      dist: {
        src: ['src/util.js', 'src/head.js', 'src/editor.js', 'src/control.js', 'src/tool.js', 'src/jquery.textae.js', 'src/tail.js', 'src/main.js'],
            ...
            return [
              ...
              function(req, res, next) {
                if (req.method === "GET") {
                  ...
                  if (req.url.indexOf("/default.json") === 0) {
