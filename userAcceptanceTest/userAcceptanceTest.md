...
9. `error` タブを選ぶ
10. `Attribute [flag] icon] "score" [add to] [edit object of] [remove from]the 1 item selected` が表示されること
...
15. `q` キーを押してパレットを開く
16. `denote` タブを選ぶ
17. `Attribute [list icon] "denote"`が表示されること
18. `error` タブを選ぶ
19. `Attribute [flag] icon] "error"` が表示されること
