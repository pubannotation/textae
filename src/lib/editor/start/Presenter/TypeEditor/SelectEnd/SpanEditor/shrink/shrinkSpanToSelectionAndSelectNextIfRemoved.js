...
export default function(editor, annotationData, command, spanAdjuster, spanId, selection, spanConfig, selectionModel) {
  const oldSpan = document.querySelector(`#${spanId}`),
    ...
    removed = shrinkSpanToSelection(editor, annotationData, command, spanAdjuster, spanId, selection, spanConfig)
