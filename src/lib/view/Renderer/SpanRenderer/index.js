...
module.exports = function(editor, model, typeContainer, entityRenderer, gridRenderer) {
    var renderBlockOfSpan = function(span, clearCache) {
        ...
        create = _.compose(renderChildresnSpan, renderEntitiesOfSpan, renderBlockOfSpan, span => renderSingleSpan(model.annotationData.span, span), destroyChildrenSpan);
