...
<div class="textae-editor__edit-type-dialog__attribute__predicate">
  ...
  <input class="textae-editor__edit-type-dialog__attribute__predicate__value" value="{{this.pred}}">
</div>
<div class="textae-editor__edit-type-dialog__attribute__value">
  <label>Value:</label><br>
  <input class="textae-editor__edit-type-dialog__attribute__value__value" value="{{this.obj}}">
</div>
