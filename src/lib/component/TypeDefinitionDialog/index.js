...
<div class="textae-editor__edit-type-definition-dialog__container">
  ...
  <label>Id:</label><br>
  <input class="textae-editor__edit-type-definition-dialog--id textae-editor__promise-daialog__observable-element" value=${
    id || ''
  }>
  </div>
  <div class="textae-editor__edit-type-definition-dialog__input-box">
  ...
  <label>Default type:<input class="textae-editor__edit-type-definition-dialog__set-default__input" type="checkbox" ${
